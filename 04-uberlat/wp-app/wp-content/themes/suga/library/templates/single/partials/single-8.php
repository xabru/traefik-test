...
?>
<div class="site-content single-layout single-entry single-entry--no-sidebar single-entry--billboard-overlap-title <?php echo esc_html($sugaExtension);?>">
    ...
    <div class="atbssuga-block atbssuga-block--fullwidth single-entry-wrap">
        <article <?php post_class('atbssuga-block post--single');?>>
                <div class="container">
