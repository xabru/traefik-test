<?php
/*
Template Name: Single Template 18
*/
?>
<?php
    global $post;
...
?>
<div class="site-content single-entry single-suga single-17 <?php echo esc_html($sugaExtension);?>">
        ...
        <div class="single-header--top clearfix">
            ...
            <?php
                if ( function_exists( 'suga_extension_single_entry_interaction__sticky_share_box' ) ) {
                    echo suga_extension_single_entry_interaction__sticky_share_box(get_the_ID(), 'share-box-1');
                }
            ?>
        </div>
