<?php 
    ...
    if ((isset($suga_option['bk-offcanvas-desktop-logo'])) && (($suga_option['bk-offcanvas-desktop-logo']) != NULL)){ 
        $logo = $suga_option['bk-offcanvas-desktop-logo'];
...
<div id="atbssuga-offcanvas-primary" class="atbssuga-offcanvas js-atbssuga-offcanvas js-perfect-scrollbar">
	<div class="atbssuga-offcanvas__title">
        ...
        <?php if ( isset($suga_option ['bk-offcanvas-desktop-social']) && ($suga_option ['bk-offcanvas-desktop-social'] != '') ){ ?>
		<ul class="social-list list-horizontal">
			<?php echo suga_core::bk_get_social_media_links($suga_option['bk-offcanvas-desktop-social']);?>
		</ul>
        <?php }?>
	...
	<div class="atbssuga-offcanvas__section atbssuga-offcanvas__section-navigation">
		<?php 
            if ( isset($suga_option ['bk-offcanvas-desktop-menu']) && ($suga_option ['bk-offcanvas-desktop-menu'] != '') ){
                if ( has_nav_menu( $suga_option ['bk-offcanvas-desktop-menu'] ) ) : 
                    $menuSettings = array( 
                        'theme_location' => $suga_option ['bk-offcanvas-desktop-menu'],
    ...
    <?php if(isset($suga_option['bk-offcanvas-desktop-mailchimp-shortcode']) && ($suga_option['bk-offcanvas-desktop-mailchimp-shortcode'] != '')) :?>
    <div class="atbssuga-offcanvas__section">
		<div class="subscribe-form subscribe-form--horizontal text-center">
            <?php echo do_shortcode($suga_option['bk-offcanvas-desktop-mailchimp-shortcode']);?>
		</div>
	</div>
    <?php endif;?>
		...
		<div class="text-center">
            <?php 
                ...
                if(!is_user_logged_in()) {
                    echo '<a href="#login-modal" class="btn btn-default" data-toggle="modal" data-target="#login-modal"><i class="mdicon mdicon-person mdicon--first"></i><span>'.esc_html_e('Login/Sign up', 'suga').'</span></a>';
                }
            ?>
		</div>
	</div>
