...
<header class="site-header">
    ...
    <!-- Navigation bar -->
    <nav class="navigation-bar navigation-bar--fullwidth text-right hidden-xs hidden-sm js-sticky-header-holder <?php if($inverseClass == "yes") echo " navigation-bar--inverse";?>">
