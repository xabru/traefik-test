    ...
    <div class="header-main hidden-xs hidden-sm">
    	...
    	<div class="container">
    		<div class="row row--flex row--vertical-center">
    			<div class="col-xs-3">
                    <?php if ( isset($suga_option ['bk-social-header']) && ($suga_option ['bk-social-header'] != '') ){ ?>
                ...
                <?php if((isset($suga_option['bk-header-subscribe-switch'])) && ($suga_option['bk-header-subscribe-switch'] == 1)):?>
                    <?php if((isset($suga_option['bk-mailchimp-shortcode'])) && ($suga_option['bk-mailchimp-shortcode'] != '')):?>
    		...
    		<div class="navigation-bar__inner">
                <?php if (is_active_sidebar('offcanvas-widget-area') || has_nav_menu( 'main-menu' ) || has_nav_menu( 'offcanvas-menu' )):?>
        			...
        			<div class="navigation-bar__section hidden-xs hidden-sm">
        				<a href="#atbssuga-offcanvas-primary" class="offcanvas-menu-toggle navigation-bar-btn js-atbssuga-offcanvas-toggle"><i class="mdicon mdicon-menu"></i></a>
        			</div>
                    <?php }?>
                <?php endif;?>
