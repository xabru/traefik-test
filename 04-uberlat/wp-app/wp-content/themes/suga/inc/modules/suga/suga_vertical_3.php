<?php
if (!class_exists('suga_vertical_3')) {
    class suga_vertical_3 {
        ...
        function render($postAttr) {
            ...
            ?>
            <article class="post post--vertical <?php if(!(suga_core::bk_check_has_post_thumbnail($postID) && isset($postAttr['thumbSize']) && ($postAttr['thumbSize'] != ''))) echo 'suga-vertical--no-thumb';?> <?php if(isset($postAttr['additionalClass']) && ($postAttr['additionalClass'] != null)) echo esc_attr($postAttr['additionalClass']);?>">
