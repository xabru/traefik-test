<?php
if (!class_exists('suga_posts_listing_list_c')) {
    class suga_posts_listing_list_c {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('suga_posts_listing_list_c-');
            $moduleConfigs = array();
           ...
           //Post Source & Icon
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbssuga-block atbssuga-block--fullwidth suga-listing-list-c atbssuga-post--list-horizontal-hasbackground '.$moduleCustomClass.'">';
