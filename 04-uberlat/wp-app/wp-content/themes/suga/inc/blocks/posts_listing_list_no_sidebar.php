<?php
if (!class_exists('suga_posts_listing_list_no_sidebar')) {
    class suga_posts_listing_list_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('suga_posts_listing_list_no_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbssuga-block atbssuga-block--fullwidth atbssuga-posts-listing-list-no-sidebar atbssuga-post--grid-horizontal-title-hasline '.$moduleCustomClass.'">';
