<?php
if (!class_exists('suga_posts_listing_grid_no_sidebar')) {
    class suga_posts_listing_grid_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('suga_posts_listing_grid_no_sidebar-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbssuga-block atbssuga-block--fullwidth posts-listing-grid-no-sidebar atbssuga-post--grid-vertical-readmore-big atbssuga-posts-listing-grid-no-sidebar '.$moduleCustomClass.'">';
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div class="atbssuga-block__inner posts-list row row--space-between grid-gutter-w50-h80 items-clear-both-3">';
        ...
        public function render_modules($the_query, $the__lastPost = 0, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();    
                    ...
                    $render_modules .= '<div class="col-md-6 col-sm-6 col-md-4 item-count">';
