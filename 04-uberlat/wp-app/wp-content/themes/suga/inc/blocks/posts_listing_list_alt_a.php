<?php
if (!class_exists('suga_posts_listing_list_alt_a')) {
    class suga_posts_listing_list_alt_a {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('suga_posts_listing_list_alt_a-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbssuga-block atbssuga-posts-listing-list-alt-a atbssuga-post--grid-horizontal-title-hasline '.$moduleCustomClass.'">';
