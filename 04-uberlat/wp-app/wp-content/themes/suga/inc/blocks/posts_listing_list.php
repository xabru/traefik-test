<?php
if (!class_exists('suga_posts_listing_list')) {
    class suga_posts_listing_list {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('suga_posts_listing_list-');
            $moduleConfigs = array();
           ...
           //Post Source & Icon
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbssuga-block posts-listing-list atbssuga-post--grid-horizontal-title-hasline '.$moduleCustomClass.'">';
