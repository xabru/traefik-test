<?php
/**
 * Plugin Name: [SUGA] Widget Review List
...
class bk_widget_review_list extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'atbssuga-widget', 'description' => esc_html__('Displays Review Posts List.', 'the-next-mag') );

		/* Create the widget. */
		parent::__construct( 'bk_widget_review_list', esc_html__('[SUGA] Widget Review List', 'the-next-mag'), $widget_ops);
	}
	...
	function widget( $args, $instance ) {
        ...
        $widgetClass = 'atbssuga-widget-reviews-list';
		...
		if ( $the_query -> have_posts() ) :
            ...
            switch ( $widgetModule ) {
                case 'review-posts-a' :
                    ...
                    echo suga_widget::bk_review_posts_a($the_query);
                    echo '</ul>';
                    break;
                
                case 'review-posts-b' :
                    echo '<ol class="posts-list review-posts-b list-space-lg list-unstyled">';
                    echo suga_widget::bk_review_posts_b($the_query);
                    echo '</ol>';
                    break;
                    
                case 'review-posts-c' :
                    echo '<ul class="posts-list review-posts-c list-space-lg list-unstyled">';
                    echo suga_widget::bk_review_posts_c($the_query);
                    echo '</ul>';
                    break;
                    
                case 'review-posts-d' :
                    echo '<ol class="posts-list list-space-sm list-unstyled">';
                    echo suga_widget::bk_review_posts_d($the_query);
                    echo '</ol>';
                    break;
